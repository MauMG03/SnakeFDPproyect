...
Ejemplos
growSnake({                                               {
           snake:[{x:5,y:2},{x:4,y:2},{x:3,y:2}],  --->     snake:[{x:5,y:2},{x:4,y:2},{x:3,y:2},{x:3,y:2}],
           section: "gamemode1"                    --->     section: "gamemode1"  
          })                                              };


growSnake({                                               {
           snake:[{x:5,y:2},{x:4,y:2},{x:3,y:2}],   --->    snake:[{x:5,y:2},{x:4,y:2},{x:3,y:2},{x:3,y:2}],
           snake2:[{x:5,y:2},{x:4,y:2},{x:3,y:2}],  --->    snake2:[{x:5,y:2},{x:4,y:2},{x:3,y:2},{x:3,y:2}],
           section: "gamemode3"                     --->    section: "gamemode3"
          })                                              };    
*/
...
eatFruit({                                                                        {
           snake: [{ x: 3, y: 1 }, { x: 2, y: 1 }, { x: 1, y: 1 }],          -->   snake: [{ x: 3, y: 1 }, { x: 2, y: 1 },{ x: 1, y: 1 }, { x: 1, y: 1 }], 
           snake2: [{ x: 21, y: 23 }, { x: 22, y: 23 }, { x: 23, y: 23 }],   -->   snake2: [{ x: 21, y: 23 }, { x: 22, y: 23 }, { x: 23, y: 23 }, { x: 23, y: 23 }],
           apple: {x: 3 , y: 1 },                                            -->   apple: { x: 15, y: 12 },
           life: 2,                                                          -->   life: 3,
           score:2500,                                                       -->   score:2600 ,
           wall: [],                                                         -->   wall: [],
           section: "gameMode3"                                              -->   section: "gameMode3" 
        })                                                                        }
...
eatFruit({                                                                        {
          snake: [{ x: 3, y: 1 }, { x: 2, y: 1 }, { x: 1, y: 1 }],           -->   snake: [{ x: 3, y: 1 }, { x: 2, y: 1 }, { x: 1, y: 1 }, { x: 1, y: 1 }],
          snake2: [],                                                        -->   snake2: [],
          apple: { x: 10, y: 12 },                                           -->   apple: { x: 11, y: 2},
          life: 2,                                                           -->   life: 2,
          score: 3200,                                                       -->   score: 3300, 
          wall: [{x:12, y:14},{x:22, y:10}],                                 -->   wall: [{x:12, y:14},{x:22, y:10},{x:20,y;10}],
          section: "gameMode2"                                               -->   section: "gameMode2"
        }) ->                                                                     }; 
*/
...
function eatFruit(Mundo) {
    ...
    if (Mundo.section == "gameMode2") {
        if ((Mundo.score % 5000 == 0) && ((Mundo.score % 200) == 0) && (Mundo.score != 0)) {
            lifeSound.play();
        ...
        if ((Mundo.score % 5000 == 0) && (Mundo.score != 0)) {
            lifeSound.play();
            lifeSound.setVolume(0.1)
...
snakeColissionBody({                                                                                                             {
  snake: [{ x: 3, y: 1 },{ x: 3, y: 2 },{ x: 4, y: 2 },{ x: 4, y: 1 },{ x: 3, y: 1 }, { x: 2, y: 1 }, { x: 1, y: 1 }],     -->    {snake:    [{ x: 3, y: 1 }, { x: 2, y: 1 }, { x: 1, y: 1 }],
  dir: {x:0,y:-1},                                                                                                         -->    dir: { x: 0, y: 0 },
  snake2: [],                                                                                                              -->    snake2: [],
  dir2:{},                                                                                                                 -->    dir2: {},
  apple: { x: 10, y: 12 },                                                                                                 -->    apple: { x: changeRandomX(), y: changeRandomY() },
  life: 2,                                                                                                                 -->    life: 1,
  score:3700,                                                                                                              -->    score:3700,
  tPower: false,                                                                                                           -->    tPower: false,
  clock: {},                                                                                                               -->    clock: {},
  pReset: 4,                                                                                                               -->    pReset:4, 
  wall [],                                                                                                                 -->    wall: [],
  section: "gameMode1"                                                                                                     -->    section:  "gameMode1"
 },                                                                                                                              }
[{ x: 3, y: 1 },{ x: 3, y: 2 },{ x: 4, y: 2 },{ x: 4, y: 1 },{ x: 3, y: 1 }, { x: 2, y: 1 },{ x: 1, y: 1 }]
,[])
*/
...
clockAppear({score: 10000, clock:{}, tPower: false, section: "gameMode1" }) -> undefined
*/
...
timePowerGet({                                                   {
              snake: [{x:5,y:2},{x:6,y:2},{x:7,y:2}],    ->       snake: [{x:5,y:2},{x:6,y:2},{x:7,y:2}],
              clock: {x:15,y:21},                        ->       clock: {x:15,y:21},
              section: "gameMode2"                       ->       section: "gameMode2"
            })                                                   }
*/
...
function setup() {
    ...
    infoInstructions.position(0, -370);
    ...
    back.position(0, 320);
    back.id("atras");
    back.class("txt-pixel");
    back.style("color", "white");

    next = createDiv("");
    next.position(300, 320);
    next.id("next");
    next.class("txt-pixel");
...
function drawGame(Mundo) {
    ...
    if (Mundo.section == "Instrucciones") {
        ...
        opcion2.html("");
        opcion3.html("");
        back.position(-350,320)
        next.html("<p class='menu'>Siguiente<p>")
        infoInstructions.html("<justify><h6><p class='info'>El snake es un juego en el cual se maneja una pequeña serpiente, tu objetivo es comer la mayor cantidad de frutas posibles, entre más frutas comas, mayor será tu puntaje pero más largo será tu cuerpo.<br><br>Controlas la dirección de la serpiente oprimiendo las flechas o usando las teclas WASD, intenta obtener la mayor cantidad de puntos posibles, contarás con 3 vidas para ello. Cada 5000 puntos que obtengas serás recompensado con una vida extra.<br><br>Perderas una vida sí la cabeza de snake choca con su cuerpo o con el cuerpo de su espejo, con un muro, o con los límites del área de juego. Si te quedas sin vidas, el juego termina.</p><h6></justify>");
    }
    if(Mundo.section == "Instrucciones2"){
      next.html("");
      infoInstructions.html("<justify><h6><p class='info'>Modos de Juego<br>Clásico:  Una serpiente, una fruta, un destino. Atrapa la mayor cantidad de frutas sin chocar con tu cuerpo ni los límites del área de juego.<br><br>Rattle N' Roll: Un modo un poco más frenético, la velocidad del juego aumenta cada 3000 puntos, además de que debes evitar chocar con muros que aparecerán dentro del área, cada 1500 puntos aparecerá un reloj que te permitirá disminuir la velocidad del juego por las proximas tres frutas que consumas, para usarlo presiona la tecla T.<br><br>Mirror: Modo espejo, aparecerá otra serpiente que tendrá la posición y dirección contraria, cuando una de las dos serpientes consume una fruta, el cuerpo de ambas se hace más largo. Evita chocar con tu cuerpo y los límites mientras evitas tu reflejo.            !Buena Suerte!</p><h6></justify>");
    }
    ...
    if ((Mundo.section == "Jugar") || (Mundo.section == "Desarrollador") || (Mundo.section == "Instrucciones")) {
        back.html("<p class='menu'>Atras</p>");
    }
...
function onTic(Mundo) {
    setSpeed(Mundo);
    if (Mundo.section == "Menu" || Mundo.section == "Jugar" || Mundo.section == "Desarrollador" || Mundo.section == "Instrucciones") {
        introSound.stop();
        gameOverSound.stop();
...
onMouseEvent({section: "Menu"}, "press") -> {section: "Instrucciones"};
*/
function onMouseEvent(Mundo, event) {
    if (event.action == "press") {
        ...
        if(Mundo.section == "Instrucciones"){
          if(((mouseX >= 25) && (mouseX <= 125)) && ((mouseY >= 445) && (mouseY <= 470))){
                return update(Mundo, { section: "Menu" });
          }
          if(((mouseX >= 350) && (mouseX <= 450)) && ((mouseY >= 445) && (mouseY <= 470))){
            return update(Mundo, {section: "Instrucciones2"})
          }  
        }
        if(Mundo.section == "Instrucciones2"){
          if(((mouseX >= 25) && (mouseX <= 125)) && ((mouseY >= 445) && (mouseY <= 470))){
        ...
        if ((Mundo.section == "Jugar") || (Mundo.section == "Desarrollador")) {
            if (((mouseX >= 200) && (mouseX <= 300)) && ((mouseY >= 445) && (mouseY <= 470))) {
                return update(Mundo, { section: "Menu" });
            }
            else return Mundo;
        }
